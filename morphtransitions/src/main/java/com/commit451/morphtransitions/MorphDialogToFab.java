...
public class MorphDialogToFab extends ChangeBounds {
    ...
    public MorphDialogToFab(@ColorInt int startColor, @ColorInt int endColor, int dialogCornerRadius) {
        super();
        setStartColor(startColor);
        setEndColor(endColor);
        setDialogCornerRadius(dialogCornerRadius);
    }
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_CORNER_RADIUS, dialogCornerRadius);
    }
